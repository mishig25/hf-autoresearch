...
# ---------------------------------------------------------------------------
# Paths: auto-detect mounted volumes (HF Jobs) vs local cache
# ---------------------------------------------------------------------------

_LOCAL_CACHE = os.path.expanduser("~/.cache/autoresearch")
DATA_DIR = "/data" if os.path.isdir("/data") else os.path.join(_LOCAL_CACHE, "data")
TOKENIZER_DIR = "/cache/tokenizer" if os.path.isdir("/cache/tokenizer") else os.path.join(_LOCAL_CACHE, "tokenizer")
...
# ---------------------------------------------------------------------------
# Runtime utilities (from prepare.py)
# ---------------------------------------------------------------------------
